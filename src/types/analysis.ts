...
export interface TimeWindow {
   ...
   */ // comment for expectedSavingCents
  expectedSavingCents: {
 ...
 */ // comment for TrendDay
export interface TrendDay {
  // start TrendDay
  /** short key for the weekday */ // comment for day
  day: WeekdayKey; // day key

  /** i18n label lookup key for UI rendering */ // comment for labelKey
  labelKey: string; // label i18n key

  /** price offset in Euro-cents relative to weekly average */ // comment for averagePriceOffset
  averagePriceOffset: number; // offset in cents

  /** whether this represents today's weekday in local time */ // comment for isToday
  isToday: boolean; // is today

  /** whether this day is flagged as historically one of the cheapest */ // comment for isCheapest
  isCheapest: boolean; // cheapest flag

  /** whether this day is flagged as historically most expensive */ // comment for isMostExpensive
 ...
 */ // comment for WeeklyTrend
export interface WeeklyTrend {
  // start WeeklyTrend
  /** ordered, readonly array of TrendDay records */ // comment for days
  readonly days: readonly TrendDay[]; // days array

  /** readonly keys for historically cheapest days */ // comment for cheapestDays
  readonly cheapestDays: readonly WeekdayKey[]; // cheapest keys

  /** readonly keys for historically most expensive days */ // comment for mostExpensiveDays
  readonly mostExpensiveDays: readonly WeekdayKey[]; // most expensive keys

  /** must be the literal string "adac_2026" */ // comment for source
  source: "adac_2026";

  /** ISO 8601 timestamp when this dataset was last updated */ // comment for lastUpdated
